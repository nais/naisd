...
func TestCreateOrUpdateSecret(t *testing.T) {
	...
	naisResources := []NaisResource{
		{1,resource1Name, resource1Type, map[string]string{resource1Key: resource1Value}, map[string]string{secret1Key: secret1Value}, files1, nil},
		{1,resource2Name, resource2Type, map[string]string{resource2Key: resource2Value}, map[string]string{secret2Key: secret2Value}, files2, nil}}
	...
	t.Run("when a secret exists, it's updated", func(t *testing.T) {
		...
		secret, err := createOrUpdateSecret(NaisDeploymentRequest{Namespace: namespace, Application: appName}, []NaisResource{
			{1,resource1Name, resource1Type, nil, map[string]string{secret1Key: updatedSecretValue}, map[string][]byte{fileKey1: updatedFileValue}, nil}}, clientset)
		assert.NoError(t, err)
...
func TestCreateK8sResources(t *testing.T) {
	...
	naisResources := []NaisResource{{1,"resourceName", "resourceType", map[string]string{"resourceKey": "resource1Value"}, map[string]string{"secretKey": "secretValue"}, nil, nil}}
	...
	naisResourcesNoSecret := []NaisResource{
		{1,"resourceName", "resourceType", map[string]string{"resourceKey": "resource1Value"}, map[string]string{}, nil, nil}}
