...
require (
	...
	github.com/prometheus/procfs v0.0.0-20180307124410-1c7ff3de94ae
	...
	golang.org/x/sys v0.0.0-20180308025116-349b81fb5c64
	golang.org/x/text v0.3.0
	gopkg.in/h2non/gock.v1 v1.0.8
	gopkg.in/inf.v0 v0.9.0
	gopkg.in/yaml.v2 v2.1.1
	k8s.io/api v0.0.0-20171214033149-af4bc157c3a2
	k8s.io/apiextensions-apiserver v0.0.0-20180308075940-afdd603f89ec
