...
func init() {
	...
	flag.StringVar(&kafkaConfig.SASL.Username, "kafka.sasl.username", "", "Username for Kafka authentication.")
	flag.StringVar(&kafkaConfig.SASL.Password, "kafka.sasl.password", "", "Password for Kafka authentication.")
